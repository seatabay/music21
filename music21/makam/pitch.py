...
class Accidental(prebase.ProtoM21Object):
    ...
    def set(self, name):
        ...
        if name in ("natural", "n", 0):
            ...
            "double-slash-flat",
            accidentalNameToModifier["double-slash-flat"],
            -8,
        ):
            ...
            "slash-quarter-sharp",
            accidentalNameToModifier["slash-quarter-sharp"],
            5,
        ):
...
class Pitch(prebase.ProtoM21Object):
    ...
    def __init__(self, name: Optional[Union[str, int]] = None, **keywords):
        ...
        if keywords:
            ...
            if "octave" in keywords:
                if keywords["octave"] in [4, 5, 6]:
                    ...
                    raise ValueError(
                        "Makam tradition does not support octave {}.".format(
                            keywords["octave"]
                        )
                    )
    ...
    def name(self, usrStr: str):
        ...
        for char in usrStr:
            if char in "456":
            ...
            elif char in "0123789" or usrStr.lower() in [
                "d6",
                "e6",
                "f6",
                "g6",
                ...
                raise ValueError("Makam tradition supports notes between C4 and C6.")
            else:
                octNot.append(char)
        usrStr = "".join(octNot)
